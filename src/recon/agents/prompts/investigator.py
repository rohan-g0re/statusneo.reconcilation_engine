...
_OUTPUT = (
    ...
    "Where only a cents field exists — a line charge on a raw record, say — quote it\n"
    "as it stands and let it be ugly. Do NOT convert it yourself. Dividing by a\n"
    "hundred is arithmetic, and arithmetic is the one thing you must never do.\n\n"
